...
frame construct_frame(frame *cur_frame, bmp *background, uint8_t num_actors, uint8_t num_layers, uint8_t maxw, uint8_t maxh, uint8_t frame_width, uint8_t frame_height);
