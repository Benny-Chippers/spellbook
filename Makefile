...
help:
	...
	@echo "  Example: make TOOLCHAIN_PREFIX=riscv64-unknown-elf-"
	@echo "  Select program source: make PROGRAM=test_rv32i"
	...
	@echo "                   VGA_IMAGE_C=build/render_image/generated/my_image.c \\"
	@echo "                   VGA_IMAGE_H=build/render_image/generated/my_image.h VGA_IMAGE_ARRAY=my_rgb"
	@echo ""
